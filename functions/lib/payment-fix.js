...
exports.checkAndFixPayment = exports.bulkFixPayments = exports.fixPaymentAndGrantTools = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// Comprehensive Payment Fix Function
exports.fixPaymentAndGrantTools = functions.https.onCall(async (data, context) => {
    try {
...
exports.bulkFixPayments = functions.https.onCall(async (data, context) => {
    try {
        ...
        for (const txn of transactions) {
            try {
                const result = await exports.fixPaymentAndGrantTools.run(txn, context);
...
exports.checkAndFixPayment = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
    ...
    try {
        ...
        const result = await exports.fixPaymentAndGrantTools.run({ merchantTransactionId: merchantTransactionId, userId: userId, toolId: toolId }, { auth: null, rawRequest: req });
...
//# sourceMappingURL=payment-fix.js.map