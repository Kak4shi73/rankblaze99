        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/pricing" className="text-indigo-200 hover:text-amber-400 transition-colors">Pricing</a>
              </li>
              <li>
              ...
              <li>
                <a href="/contact" className="text-indigo-200 hover:text-amber-400 transition-colors">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/faq" className="text-indigo-200 hover:text-amber-400 transition-colors">FAQ</a>
              </li>
              <li>
